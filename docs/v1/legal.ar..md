...
<details>
  <summary><strong>Definitions</strong> (optional)</summary>
  <ul>
    <li><strong>Personal Data:</strong> information that identifies or can be linked to a specific person, such as email or phone number.</li>
    <li><strong>Sensor Data:</strong> data originating from your devices’ sensors for analysis and display inside the App.</li>
  </ul>
</details>
...
<details>
  <summary><strong>Additional Notices</strong> (optional)</summary>
  <p>
